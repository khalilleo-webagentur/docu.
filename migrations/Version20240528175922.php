 ...
 */
final class Version20240528175922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE docu_item (id INT AUTO_INCREMENT NOT NULL, catigory_id INT NOT NULL, slug VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, read_time VARCHAR(10) NOT NULL, likes INT NOT NULL, dis_likes INT NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_8BE01E0345E988AD (catigory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
